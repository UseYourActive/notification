...
public class ViberSendException extends NotificationException {
    ...
    public ViberSendException(NotificationErrorCode errorCode, String title, String detail, String recipient) {
        super(errorCode, ErrorCategory.NOTIFICATION_SENDING, title, detail);
        this.recipient = recipient;
    }

    public ViberSendException(NotificationErrorCode errorCode, String title, String detail, String recipient, Throwable cause) {
